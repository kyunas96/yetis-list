...
* We then check to see if the email already exists in our database on MongoDB. If there are no duplicates then a new user is created using our schema built with Mongoose. 
